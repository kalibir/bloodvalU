...
from apps.offeredtests.views import CreateOfferedTestView, RetrieveUpdateDestroyOfferedTestView, BuyOfferedTestView, \
    ListAllSeekersOfferedTestsView, ListDonorsWhoBoughtOfferedTest, ValidateOfferedTestQRCodeView
...
urlpatterns = [
    ...
    path('customers/', ListDonorsWhoBoughtOfferedTest.as_view(), name='get-buyers-of-specific-request'),
    path('validate/', ValidateOfferedTestQRCodeView.as_view(), name='get-buyers-of-specific-request'),
