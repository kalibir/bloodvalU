...
from apps.offeredtests.views import CreateOfferedTestView, RetrieveUpdateDestroyOfferedTestView, BuyOfferedTestView, \
    ListAllSeekersOfferedTestsView, ListDonorsWhoBoughtOfferedTest, ValidateQRCodeView
...
urlpatterns = [
    ...
    path('validate/', ValidateQRCodeView.as_view(), name='get-buyers-of-specific-request'),
